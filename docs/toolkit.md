...
and `horn_hawking` (analog Hawking radiation — a de Laval sonic horizon at the throat; surface
gravity extracted two independent ways whose agreement is the trust flag; sharper throat -> hotter T_H).
